                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>كود الحجز : </small>  {{$pr->opid}} <br />
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small> اسم الموظف: </small>  {{$pr->employname}} <br />
            ...
            <tr>
              <td>
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    <tr>
                      <th style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; font-weight: normal; line-height: 1; vertical-align: top; padding: 0 10px 7px 0;" width="52%" align="right">
                        معلومات الحجز  :
                      </th>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;"><small> {{$pr-> operationprice }}  </small></td>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="center">  {{$pr-> visatype }} </td>
...
var playersRef9902 = playersRef990.child('{{$pr->opid}}');
...
<div class="one">
                   <a href="/booknow/{{$pr->opid}}" id="clk" class="curve"> نعم ، احجز الآن </a>
                </div>
                <div class="one">
                    <a href="/editop/{{$pr->opid}}" id="clk2" class="curve"> لا ، تعديل معلومات الحجز </a>
                </div>
                <div class="one">
                  <a href="/deletebook/{{$pr->opid}}" class="curve"> احذف عملية الحجز</a>
                </div>
                <p> &nbsp;</p>
              <p> &nbsp;</p>
              <p> &nbsp;</p>
...
window.location.href="/booknow/" <?php echo $pr->opid ?> ;

};
document.getElementById("clk2").onclick = function () {

//window.location.href="/editop/" <?php echo $pr->opid ?> ;

};
  
document.getElementById("clk3").onclick = function () {

//window.location.href="/deletebook/" <?php echo $pr->opid ?> ;
