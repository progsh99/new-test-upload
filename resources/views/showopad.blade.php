...
<center>
        ...
        <h3>  {{ $pr->des  }} </h3>
			...
			<a href="/upload/{{$pr->mainid}}" id="mybu" class="btn btn-primary stretched-link" >حجز الآن    :</a>	
			</br>	
			</br>	
		
			<a href="/beaf/{{$pr->mainid}}" id="mybu2" class="btn btn-primary stretched-link" >عرض نتائج العملية      :</a>	
