...
<center>
<button  id="addfile" class="btn btn-primary"style="margin-top:10px ;"> اضافة صورة العرض   </button>
</center>
...
var filename =  $('#my-file').val();
     ...
     var databaseref99 = firebase.database().ref().child('offers/{{$prm->id}}/');
   //  var databaseref99 = databaseref9900.child('ex/');
         ...
         var stoargeRef99 = firebase.storage().ref('offers/{{$prm->id}}/') ; // folder name
