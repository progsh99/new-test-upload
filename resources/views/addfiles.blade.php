...
<form action="#">
  <div class="input-file-container">  
    ...
    <label tabindex="0" for="my-file" class="input-file-trigger" required> صورة الجواز : يرجى رفعها كصورة وليس ملف pdf  </label>
  </div>
...
<center>
<button  id="addfile" class="btn btn-primary"style="margin-top:10px ;"> اضافة الجواز  </button>
</center>
...
<form action="#">
  <div class="input-file-container">  
    ...
    <label tabindex="0" for="my-file2" class="input-file-trigger">    ملفات اخرى ربما ترغب بارفاقها :  </label>
  </div>
  <p class="file-return"></p>
</form>
</br>
...
<center>
<button  id="addfile2" class="btn btn-primary"style="margin-top:10px ;"> اضافة الملفات  </button>
</center>
...
<center>
<button  id="addfile3" class="btn btn-primary"style="margin-top:10px ;"> احجز الان </button>
</center>
...
var filename =  $('#my-file').val();
     ...
     var databaseref99 = firebase.database().ref().child('officeops/{{$prm->opid}}/passport/');


         var name = picture["name"] ;

  
         var stoargeRef99 = firebase.storage().ref('officeops/{{$prm->opid}}/passport/') ; // folder name
...
var filename =  $('#my-file2').val();
     ...
     var databaseref99 = firebase.database().ref().child('officeops/{{$prm->opid}}/files/');
         ...
         var stoargeRef99 = firebase.storage().ref('officeops/{{$prm->opid}}/files/') ; // folder name
      
    //   var newvar = editnum.toString() ;
       // var mynewstep = stoargeRef99.child(newvar) ; 
...
window.location.href = '/savepass/{{$prm->opid}}' ;
//window.location.href = '/savepass/';
});
