                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right">   {{$pr3-> tickettype }} </td>
              ...
              <td>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #b0b0b0; line-height: 22px; vertical-align: top; text-align:right; "><small>  السعر الغير نهائي  </small></td>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #b0b0b0; line-height: 22px; vertical-align: top; text-align:right; ">
                        <small>  {{$pr3-> beforefinalprice }} $  </small>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <strong> المبلغ المسترجع للزبون </strong>
                      </td>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                        <strong>{{$pr3-> backprice }} $   </strong>
                      </td>
                    </tr>
...
@php $images2 = json_decode($pr3->passport,true); @endphp
                             <img src ="{{ secure_asset($pr3->opid .'/passport/'.$images2) }}" width="250"  height="350" >                    
                              </td>
                            </tr>
                            <tr>
...
<div class="one">
                    <a ><button id="clk" class="curve"> تحميل كصورة</button></a>
                </div>
              <p> &nbsp;</p>
              <p> &nbsp;</p>
              <p> &nbsp;</p>
